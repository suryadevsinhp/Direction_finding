...
if __name__ == "__main__":
    ...
    # "shmem"!
    # creating gpio_control screen
    # os.system("screen -dmS gpio_controller")
    # os.system('screen -S gpio_controller -p 0 -X stuff "cd /home/krakenrf/\n"')
    # os.system('screen -S gpio_controller -p 0 -X stuff "python3 gpio_controller.py\n"')
